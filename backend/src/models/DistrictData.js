...
// This schema is based on your src/types/index.ts file
...
// This creates a collection named 'districtdatas' in your database
const DistrictData = model('DistrictData', districtDataSchema);
